...
export const companyProfile: CompanyProfile = {
	...
	name: _stringOrFallback(rawCompanyProfile.name, 'Старий млин'),
...
function _normalizeSeoMetadata(
	...
	return {
		title: _stringOrFallback(metadata?.title, _stringOrFallback(companyName, 'Старий млин')),
		description: _stringOrFallback(metadata?.description),
		keywords: _stringArrayOrFallback(metadata?.keywords),
		author: _stringOrFallback(metadata?.author, _stringOrFallback(companyName, 'Старий млин')),
...
function _normalizePageSeo(
	pageSeo: RawCompanyProfile['pageSeo'],
...
function _normalizeStructuredData(
	...
	return {
		...
		servesCuisine: _stringOrFallback(structuredData?.servesCuisine, 'Ukrainian, Galician'),
